\begin{tikzpicture}[>=stealth]
  ...
  \draw ( 0.5, 0.5) node {$\scriptstyle{0}$}
        ...
        ( 2.5, 0.5) node {$\scriptstyle{2}$}
        ( 3.5, 0.5) node {$\cdots$}
        ( 4.5, 0.5) node {$\scriptstyle{r-1}$}
        ( 5.5, 0.5) node {$\scriptstyle{r}$}
        ( 6.5, 0.5) node {$\scriptstyle{r+1}$};
  \draw (-0.5,-0.5) node {$\scriptstyle{0}$}
        (-0.5,-1.5) node {$\scriptstyle{1}$}
        (-0.5,-2.5) node {$\scriptstyle{2}$}
        (-0.5,-3.5) node {$\vdots$}
        (-0.5,-4.5) node {$\scriptstyle{r-1}$}
        (-0.5,-5.5) node {$\scriptstyle{r}$}
        (-0.5,-6.5) node {$\scriptstyle{r+1}$}
        (-0.5,-7.5) node {$\scriptstyle{r+2}$};
