...
\begin{frame}
  ...
  \begin{center}
    \textbf{
       Anomalous dimensions couple back into beta functions\\
       $\Rightarrow$ sign of scalar contribution may have impact on matter bounds
    }
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \textbf{
      Vertex expansion breaks (classical) diffeomorphism invariance,\\
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Background independence:}
      \fontsize{8pt}{7.2}\selectfont
      \begin{itemize}
        \item background independent formulation can be found in some cases
        \item restricts (some) of the freedom in choosing the scheme (cutoff-operator)
