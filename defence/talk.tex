...
\begin{frame}
  ...
  \end{align*}
  \hfill[Morris `16, Percacci, Vacca `16, Percacci et. al `17]
\end{frame}
...
% TODO:
% Add 1/2 trace and nice pictures

\begin{frame}
  \frametitle{RG dynamics of interaction vertices}

  \includegraphics[width=0.95\linewidth,clip=true,trim=3cm 24cm 0cm 2cm]{frge_vertex.pdf}
...
% TODO:
% plots for eta = 0 and != 0
% problems w/ g_\star < 0
% higher truncations
