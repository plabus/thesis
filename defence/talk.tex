...
% !!! examples:
% QCD, (Yang-Mills), Gross-Neveu (d=3),
% Gauge-Yukawa theories in Veneziano-limit [Litim, Sannino]
...
% TODO:
% !!! May I use triviality?
% nicer version of pic
  ...
  \begin{columns}[T]
    \begin{column}{.5\textwidth}
      \begin{center}
        ...
        No asymptotic freedom in QCD for $N_f > 16.5$!
      \end{center}
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[scale=0.25]{triviality.png}\\[5pt]
        Can gravity stabilise matter?
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \end{align*}
  \begin{itemize}
    \item early Universe cosmology and inflation [Wetterich et al., Bonanno]
...
% TODO:
% !!! hTT leg to the left horizontally
