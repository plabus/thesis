...
\begin{frame}
  \frametitle{Substracting the cutoff-dependence via the msWI}
  ...
  \vspace{3pt}
  Possible causes:\\
  metric parametrisation (linear vs. exponential), York--decomposition, background field approxmation vs fluctuation
  field calculation, ...
  ...
  \begin{center}
    \textbf{
      ...
      and can we substract it using the msWI?
    }
  \end{center}
      ...
      \begin{center}
        \begin{itemize}
          \item
            ...
            gravition mass behaviour improved
          \item
