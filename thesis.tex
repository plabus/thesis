...
\begin{figure}[t]
  ...
  \caption{
    ...
    in two different gauges (orange and cyan line).
  }
...
\begin{figure}[t]
  ...
  \caption{
    ...
    The dashed line at $\NS = 17$ shows where $\eta_h(0)$ exceeds 2,
    whereas the one at $\NS = 45$ shows where $\eta_h(k^2)$ exceeds 2.
  }
...
\section{Obtaining fluctuation couplings using the Ward identities}
