...
\begin{align}
  ...
  \right]
\end{align}
and ensuring energy conservation $\sum_{i} p_i = 0$. Similar rules for the other combinations
...
of the vertices in momentum space as well as the York decomposed from of the
