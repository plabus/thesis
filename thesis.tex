...
\begin{figure}
  ...
  \caption{
    ...
    Wilson-Fisher fixed point for $\sigma^\star = -0.1861$.
  }
...
\end{align}
In $d=3$, there is however an additional spike for $\sigma^\star = -0.1861$,
which corresponds to the Wilson-Fisher fixed point
and belongs to the bi-critical Ising universality class.
% The resulting potential has two minima and is shown in ...
