...
\begin{align}
  S_{\,\mathrm{ghost}}^{(h)} = \int \mathrm d^dx \, \sqrt{\bar g} \; C \, (-\bnabla^2) \, C \,.
\end{align}
...
\begin{align}
  S_{\mathrm{EH}} = \int \mathrm d^dx \, \sqrt g \; R
\end{align}
...
Here we discuss the changes introduced by having a scalar multiplet for the model of Eqn.~(\ref{action}).
