...
solve it.
In doing so, one observes that for most values of $\sigma$ the solutions end
...
\begin{align}
  d_V a_{00}     &= \left(  \frac{d_R}{6} + \frac{\eta}{12} \right) \frac{1}{1 -  2a_{20}} \,, \\
  2\rho\, a_{00} &= \frac{\rho}{3} \, \frac{1}{1 -  2a_{20}} \,.
\end{align}
...
\end{align}
% The volume coefficient $\mathrm{vol} \equiv \int \mathrm{d}^d x \sqrt{\bar g}$
% will later also factor out in the functional traces, so that it
% effectively drops out of the calculation.
...
\begin{align}
  ...
  \partial_t F &= - \frac{1}{\mathrm{vol}} \, \frac{\partial}{\partial R} \, \partial_t \Gamma_k  \, \bigg|_{\bR=0} \,,
\end{align}
