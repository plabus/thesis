...
\begin{align}
  ...
  % \right) .
  % \label{eq:betag3}
  \beta_{G_{(3,0)}} &= G_{(3,0)} \left(2+3 \eta_h\right)+ \beta_{G_{(3,0)}}\Big|_{\rm grav}
  - G_{(3,0)}^{1/2} \,G_{(1,2)}^{3/2}\, \NS \frac{86+\etaS}{1140 \pi} \,,
  \label{eq:betaG3}\\[2ex]
  \beta_{G_{(1,2)}} &= \left(2 +\eta_h+ 2\etaS\right)G_{(1,2)}
  -  \frac{2G_{(1,2)}^2}{3\pi}  \left(6-\eta_h\right)+\frac{ 2\sqrt{G_{(3,0)}}G_{(1,2)}^{3/2} }{\pi}3(8-\eta_h)
  \,,
  \label{eq:betag3} \\
  \beta_{\Gback} &= 2 \Gback - \frac{79}{24\pi} \Gback^2
  + \Gback^2 \, \NS \, \frac{1}{24\pi}(4-\etaS) \,.
  \label{eq:betaGbar}
\end{align}
