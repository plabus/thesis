...
\begin{align}
  \label{fbar-general}
  \bar{\gamma} = \frac{d}{2} \, \frac{\partial}{\partial\bc} \log
  \left[
...
we also have $d_R=d_V=2(2-d_f)$ and $\bar{\gamma}=2\partial_{\bc}\log\bar{f}(\bc)$.
...
\begin{align}
  ...
  \log \left[ \bar{f} \left({\rm e}^{\eta t/2}\mu^{\eta/2}\bc \right) \right] ,
\end{align}
