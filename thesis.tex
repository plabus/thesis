...
a gauge has to be fixed in order to remove spurious gauge configuration.
...
covariant derivatives of the background metric, in such a way that there necessarily
is an asymmetry between these two fields introduced. This is a then an additional
...
\begin{align}
  ...
  \weyl \overbar h^\pert &= - 2 \, \varepsilon \, ( \overbar h + d ) \,, \\
  \weyl      \hT_{\mu \nu} &= 0 \,.
\end{align}
