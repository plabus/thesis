...
by introducing a Grassmann-valued vector field $C^{\mu}(x)$ with the following action
\begin{align}
  S_{\mathrm{ghost}} = - \int \mathrm{d}^dx \, \sqrt{\bar{g}} \;
  \overbar{C}_{\mu} \, M[\bar{g},\,h]^{\mu}{}_{\nu} \, C^{\nu} \,,
\end{align}
where $\overbar{C}_{\mu}$ is the conjugate field and the inverse propagator is given by:
\begin{align}
  M[\bar g, \, h ]^{\mu}{}_{\nu} = \bar{g}^{\mu\rho} \, \bar{g}^{\sigma\lambda} \, \bnabla_\lambda
  \big(
    g_{\rho\nu}     \nabla_{\sigma}
    + g_{\sigma\nu} \nabla_{\rho}
  \big)
  - \bar{g}^{\rho\sigma} \, \bar{g}^{\mu\lambda} \, \bnabla_\lambda \, g_{\sigma\nu} \nabla_{\rho} \,.
\end{align}
