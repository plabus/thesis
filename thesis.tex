...
\begin{align}
  ...
  \label{eq:def-I}
\end{align}
Here, $F_{\text{\tiny RG}}(\bar \Delta)$ is the functional introduced in \eqref{eq:FA}.
...
\begin{align}
  ...
  \frac{1}{2} \,
	...
	\Tr\, \partial_t F_{\text{\tiny RG}}(\overbar\Delta)\,,
\end{align}
where we defined the functional
\begin{align}
	F_{\text{\tiny RG}}(x)= \int_{x_0}^x \mathrm dx' \;
  \frac{\partial R_k(x')}{\partial x'} \, G_k(x') \,.
  \label{eq:FA}
\end{align}
Note that the functional $F_{\text{\tiny RG}}(x)$ is potentially
...
\begin{align}
  \frac{1}{2} \, \Tr \,
  \partial_t F_{\text{\tiny RG}}(\overbar \Delta) \bigg|_{\Tr \overbar F^2}
...
\begin{align}
  ...
  \bigg[
    \frac{1}{\sqrt{\bar g}}
    \left( \frac{\delta}{\delta \bar g_{\mu\nu}} \sqrt{\bar g} \right) F_{\text{\tiny RG}}
  \bigg]
  \nonumber \\
  &=
  \frac 14 \, \bar g^{\mu\nu} \, \Tr \, \Big( G_k R_k - F_{\text{\tiny RG}} \Big)
...
\begin{align}
  ...
  I_2 = \frac 12 \, \Tr \, F_{\text{\tiny RG}} \,, \quad
...
\begin{alignat}{4}
  F_\text{\tiny RG}(-\partial_\tau) \,
  &\tau^{-2}
  \, &=& \,
  \int_0^\infty \mathrm dx \; x \, F_\text{\tiny RG}(x)
  \, &=& \,
  - \frac 13 \frac{k^{6-2b}}{(1+a\lambda)^b} \,,
  \label{eq:threshold-I2-const} \\
  F_\text{\tiny RG}(-\partial_\tau) \,
  &\tau^{-1}
  &=& \int_0^\infty \mathrm dx \; F_\text{\tiny RG}(x)
