...
on all other couplings $g_j$ as well as explicitly on the scale $k$.
...
infinite system of coupled flow equations for the dimensionless
...
of the coupling. However, as we will see shortly, it is the second term,
the quantum contribution,
which may induce a non-trivial fixed point.

Has we have hinted already above, the easiest way to guarantee that all
couplings of the theory remain finite in the ultraviolet limit of the
renormalisation group flow, is to demand that all couplings are scale
invariant, \ie they do change their value along the flow,
$\partial_t g_i = 0$.
