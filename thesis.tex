...
\begin{itemize}
  ...
  \item failures of GR / where we expect QM should become significant
    \begin{itemize}
      \item black holes / information paradox
  ...
  \item asymptotic safety and QG as a QFT
    \begin{itemize}
      ...
      \item tool: (Functional) Renormalisation Group ---> cf. next chapter
    \end{itemize}
\end{itemize}

\section*{Outine of the thesis}
\addcontentsline{toc}{section}{Outine of the thesis}
What we are doing in this thesis, blah, blah.
...
\begin{figure}
  \centering
  \includegraphics[scale=0.23]{two-loop-cropped.pdf}
  % \vskip-30pt
